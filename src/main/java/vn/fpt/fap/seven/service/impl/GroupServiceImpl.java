...
public class GroupServiceImpl implements GroupService {
    ...
    /*@Override
    public GroupResponse findGroupByStudentIdAndSemIdAndSId(int studentId, int subId, int semId) {
        Group group = groupRepository.findGroupByStudentIdAndSemIdAndSId(studentId, subId, semId);
